defmodule Kaffy.ResourceSchema do
  ...
  def primary_key_value(_conn, schema) do
    key = singular_pk(schema.__struct__)

    kaffy_field_value(schema, key)
  end
